...
/* defined consts */
const uint16_t uart2_tx = GPIO_PIN_2; /* usart2 tx gpio (PIN 2) */
const uint16_t uart2_rx = GPIO_PIN_3; /* usart2 rx gpio (PIN 3) */
...
void uart_send(uint8_t c); /* sends char to uart port /*
