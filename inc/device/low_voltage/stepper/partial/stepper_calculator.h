...
Speed_params convertSpeedToRegisters(float stepsPerUnit, float speed); // converts speed value to 3 registers values
...
uint32_t convertWayToSteps(float stepsPerUnit, float way); // converts way to steps number (calculates unloaded steps)
