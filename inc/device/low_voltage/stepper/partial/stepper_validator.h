...
uint8_t stepper_validateSwitch(Stepper *stepper, uint8_t *state, uint8_t *);
uint8_t stepper_validateMove(Stepper *stepper, uint8_t *way, uint8_t *direction);

uint8_t stepper_validatePause(Stepper *stepper, uint8_t *, uint8_t *);
uint8_t stepper_validateResume(Stepper *stepper, uint8_t *, uint8_t *);
uint8_t stepper_validateStop(Stepper *stepper, uint8_t *, uint8_t *);
