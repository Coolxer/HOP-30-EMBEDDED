...
const float X_HOME_FAST_BACKWARD_SPEED = 50.0f;
const float X_HOME_FAST_BACKWARD_ACCELERATION = 30.0f;

const float X_HOME_SLOW_FORWARD_SPEED = 25.0f;
const float X_HOME_SLOW_FORWARD_ACCELERATION = 15.0f;

const float X_HOME_PRECISE_BACKWARD_SPEED = 15.0f;
const float X_HOME_PRECISE_BACKWARD_ACCELERATION = 8.0f;
