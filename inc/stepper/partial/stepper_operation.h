...
uint8_t stepper_move(Stepper *stepper, uint8_t *way);      // moves stepper motor by given number of steps (can be break by endstop clicked or pause / stop) [way in mm or deg.]
