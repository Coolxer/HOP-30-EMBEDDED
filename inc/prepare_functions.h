...
uint8_t *prepare_settings(uint8_t ***args, uint8_t size, uint8_t *key, uint8_t (*fun)(Stepper*, uint8_t*)); // switch, speed, microstepping
...
uint8_t *prepare_intervention(uint8_t ***args, uint8_t size, void (*fun)(Stepper*, uint8_t*)); // pause, resume, stop
