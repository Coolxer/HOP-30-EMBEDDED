...
{
    uint8_t data[] = "idx=1|opt=pau|abc=x|\n";
...
{
    uint8_t data[] = "idx=1|opt=pau|spp=a|\n";
...
void test_prepare_intervention_pause_should_give_operation_not_allowed_error()
{
    ...
    uint8_t data[] = "idx=1|opt=pau|spp=x|\n";
...
{
    // pause pro
    uint8_t data[] = "idx=1|opt=pau|spp=pro|\n";
    TEST_ASSERT_EQUAL_STRING("idx=1|res=fin|\n", connector_manage(connector_parse(data)));

    // pause all
    uint8_t data1[] = "idx=1|opt=pau|spp=all|\n";
    TEST_ASSERT_EQUAL_STRING("idx=1|res=fin|\n", connector_manage(connector_parse(data1)));

    // pause individual
    Stepper *stepper = (Stepper *)device_manager_getStepper((uint8_t *)"x");
    stepper_setState(stepper, MOVING);

    uint8_t data2[] = "idx=1|opt=pau|spp=x|\n";
...
{
    // resume pro
    uint8_t data[] = "idx=1|opt=res|spp=pro|\n";
    TEST_ASSERT_EQUAL_STRING("idx=1|res=fin|\n", connector_manage(connector_parse(data)));

    // resume all
    uint8_t data1[] = "idx=1|opt=res|spp=all|\n";
    TEST_ASSERT_EQUAL_STRING("idx=1|res=fin|\n", connector_manage(connector_parse(data1)));
    ...
    uint8_t data2[] = "idx=1|opt=res|spp=x|\n";
    TEST_ASSERT_EQUAL_STRING("idx=1|res=fin|\n", connector_manage(connector_parse(data2)));
}
...
{
    // stop pro
    uint8_t data[] = "idx=1|opt=sto|spp=pro|\n";
    TEST_ASSERT_EQUAL_STRING("idx=1|res=fin|\n", connector_manage(connector_parse(data)));

    // stop all
    uint8_t data1[] = "idx=1|opt=sto|spp=all|\n";
    TEST_ASSERT_EQUAL_STRING("idx=1|res=fin|\n", connector_manage(connector_parse(data1)));
    ...
    uint8_t data2[] = "idx=1|opt=sto|spp=x|\n";
    TEST_ASSERT_EQUAL_STRING("idx=1|res=fin|\n", connector_manage(connector_parse(data2)));
}
